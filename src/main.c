   ...
   while (!WindowShouldClose())
   {
      ...
      // handle keyboard input
      {
         ...
         while (key != 0)
         {
            ...
            ////////////////////////////////////////////////////////////////////
            // TODO: right now this set up of tracking the entry and the cell
            // isn't working. The cell has access to the entry so   do that
            // instead. What I need to figure out, though, is how to allow the
            // user to press tab to get to the next clue. Use key == KEY_TAB
            ////////////////////////////////////////////////////////////////////
   ...
   else
   {
      ...
      for (size_t i = 0; i < cw->num_entries; ++i)
      {
              ...
              ++word_offset)
         {
            ...
            bool valid = true;
            for (size_t word_index = 0; word_index < w->word_length;
                 ++word_index)
            {
